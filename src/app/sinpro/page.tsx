    ...
    items && (
      <div className="my-10 px-40">
        <section className="flex items-start gap-16">
          <picture className="w-1/3 inline-block rounded-2xl border-2 border-[var(--neutral-03)] overflow-hidden">
            <img className="w-full" src={items.img} alt="" />
          </picture>
          <div className="flex flex-col gap-4">
            <h1 className="font-bold third-font text-3xl">
              {items.name}{" "}
              <mark className="bg-transparent third-font text-xl font-light uppercase text-[var(--neutral-04)]">
                {items.cato}
              </mark>
            </h1>
